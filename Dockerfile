...
ENTRYPOINT ["java", "-javaagent:/app/newrelic/newrelic.jar", "-Dnewrelic.config.license_key=${NEW_RELIC_LICENSE_KEY}", "-Dnewrelic.config.app_name=snippets-app",  "-jar", "/app/snippets.jar"]